...
/**
 * handleDownload downloads specified chapters of a webtoon and saves details like 
 ...
 * @param {number[]} chapterIndexes - An array of indexes specifying which chapters to download.
 * 
